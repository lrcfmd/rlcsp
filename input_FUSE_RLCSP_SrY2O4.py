...
The input file to run fuse with RLCSP for SrY2O4
...
composition = {'Sr':[1,+2],'Y':[2,+3],'O':[4,-2]} #composition in ionic format
...
run_fuse(composition=composition,search=search,rmax=rmax,
        ...
        kwds=kwds,gulp_opts=gulp_opts,lib=lib,shel=shel,
         params_db={'host': 'HOST',
                                ...
                                'password': '!PASSWORD'},
         alpha=0.0005,
         reinforce_table='fuse_reinforce_SrY2O4' + dir_num,
         theta_table='fuse_reinforce_SrY2O4_theta' + dir_num,
